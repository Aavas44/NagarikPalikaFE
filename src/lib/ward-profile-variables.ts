...
export const WARD_AUTO_FIELD_META: {
  ...
  { key: "application_date", label: "आवेदन मिति" },
  { key: "today", label: "मिति" },
  { key: "मिति", label: "मिति" },
  { key: "current_address", label: "हालको ठेगाना" },
  { key: "निवेदकको_ठेगाना", label: "निवेदकको ठेगाना" },
  { key: "current_district_name", label: "हालको जिल्ला" },
  { key: "current_applicant_local_level", label: "हालको स्थानीय तह" },
  { key: "current_applicant_ward_no", label: "हालको वडा नं." },
  { key: "district_name", label: "जिल्ला" },
  { key: "जिल्ला", label: "जिल्ला" },
  { key: "local_body_name", label: "स्थानीय तह" },
  { key: "स्थानीय_तह", label: "स्थानीय तह" },
  { key: "नगरपालिका_वा_गाउँपालिका", label: "स्थानीय तह" },
  { key: "local_body_type", label: "स्थानीय तहको प्रकार" },
  { key: "ward_no", label: "वडा नं." },
  { key: "operator_name", label: "सञ्चालकको नाम" },
  { key: "former_local_body_type", label: "पूर्व स्थानीय तहको प्रकार" },
  { key: "former_local_body_name", label: "पूर्व स्थानीय तह" },
  { key: "former_ward_no", label: "पूर्व वडा नं." },
  { key: "former_address", label: "साविक ठेगाना" },
  { key: "साविक_ठेगाना", label: "साविक ठेगाना" },
];
